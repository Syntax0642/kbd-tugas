...
class PersegiPer extends StatefulWidget {
  const PersegiPer({Key? key});

  @override
  State<PersegiPer> createState() => _PersegiPerState();
}
  ...
  return Container  (
    child: TextField(
      ...
      decoration: InputDecoration(
        ...
        labelText: "Please insert the amount of sides",
        hintText: "e.g. 5 cm",
...
class _PersegiPerState extends State<PersegiPer> {
                          ...
                          children: [
                            ...
                            Container(
                              child: Container(
                                ...
                                child: Obx(
                                        ()=>Text('${control.hasilLuasPersegi.value}Cm',style: TextStyle(fontSize: 20),)
                                ),
                              ),
                              width: 175,
                              height: 200,
